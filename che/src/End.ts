...
class End extends egret.DisplayObjectContainer {
    ...
    private thatstage;
    private lottery(e:egret.TouchEvent){
        this.thatstage = this;
        var that = this;
        this.stage.removeChildren();
        var name: egret.TextField = new  egret.TextField;
        var mobile: egret.TextField = new egret.TextField;
        var postBtn:egret.Bitmap = new egret.Bitmap;

        var result1:egret.Bitmap = new egret.Bitmap;
        var resultBtn1:egret.Bitmap = new egret.Bitmap;
        ...
        var result2:egret.Bitmap = new egret.Bitmap;
        var resultBtn2:egret.Bitmap = new egret.Bitmap;
        ...
        resultBtn2.addEventListener(egret.TouchEvent.TOUCH_TAP,function(e:egret.TouchEvent){
            that.stage.removeChildren();
            var message:egret.Bitmap = that.createBitmapByName('message');
            ...
            mobile.bold = true;
            mobile.width = 200; mobile.height = 50;
            ...
            var alertMessage:egret.TextField =new egret.TextField;
            postBtn.addEventListener(egret.TouchEvent.TOUCH_TAP,function(e:egret.TouchEvent){
                ...
                api.nxd_add_user(name.text,Number(mobile.text),'',function(){
                    var success:egret.Bitmap = new egret.Bitmap;
                    ...
                    var endWord: egret.TextField = new egret.TextField;
                    ...
                    var restart:egret.Bitmap = new egret.Bitmap;
                    restart  = that.createBitmapByName('weiweipinche');
                    restart.x = 250+15;
                    restart.y = 550;
                    restart.touchEnabled = true;
                    that.stage.addChild(restart);
                    restart.addEventListener(egret.TouchEvent.TOUCH_TAP,function(e:egret.TouchEvent){
                    ...
                    shareBtn.addEventListener(egret.TouchEvent.TOUCH_TAP,function(){
                        var shareMask:egret.Bitmap = new egret.Bitmap;
